...
- (void)viewForiOSSeven{
    ...
    CGRect frame0 = tv.frame;
    CGRect frame1 = questionHeader.frame;
    CGRect frame2 = backgroundImg.frame;
    ...
    frame1.origin.y +=20;
    questionHeader.frame = frame1;
    
    frame2.origin.y +=20;
    backgroundImg.frame = frame2;
...
-(IBAction)saveAndContinue:(id)sender{
   // 1. verificationSMS send verification code by sms
    ...
    //NSLog(@"file %d-%d-%d-%d-%d-%d", [mPref getAllGermanProvider], [mPref getTmobile], [mPref getVodafone], [mPref getEPlus], [mPref getOTwo], [mPref getTelogic]);
