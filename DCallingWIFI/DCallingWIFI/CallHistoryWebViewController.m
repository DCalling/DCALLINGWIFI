//
//  CallHistoryWebViewController.m
//  DCalling WiFi
//
...
#import "CallHistoryWebViewController.h"
#import "PreferencesHandler.h"
#import "CallerIDViewController.h"
@implementation CallHistoryWebViewController
...
- (void)viewDidLoad
{
    ...
    //NSString * urlAddress = [NSString stringWithFormat:@"https://login.dcalling.mobi/app/call-history.html?token=%@&L=%@", token, @"0"];
    NSString * language = [[NSLocale preferredLanguages] objectAtIndex:0];
    NSString * urlAddress;
    if([language isEqualToString:@"de"] || [language isEqualToString:@"tr"])
        urlAddress = [NSString stringWithFormat:@"https://login.dcalling.mobi/app/call-history1.html?token=%@&L=%@", token, @"0"];
    else {
        urlAddress = [NSString stringWithFormat:@"https://login.dcalling.mobi/app/call-history1.html?token=%@&L=%@", token, @"1"];
    }
