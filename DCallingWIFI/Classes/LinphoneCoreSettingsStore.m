...
- (void)transformLinphoneCoreToKeys {
	...
	{	
        ...
        LinphoneMediaEncryption menc=LinphoneMediaEncryptionZRTP;
		const char *val;
		switch(menc){
	...
	[self setBool: lp_config_get_int(conf, LINPHONERC_APPLICATION_KEY, "wifi_only_preference", 1) forKey:@"wifi_only_preference"];
    ...
    {
        //commented by prashant and set val true
        ...
        //[self setBool:TRUE forKey:@"sipinfo_dtmf_preference"];
        //[self setBool:TRUE forKey:@"rfc_dtmf_preference"];
...
- (BOOL)synchronize {
    ...
    //NSLog(@"df %hhd - %hhd", [self boolForKey:@"sipinfo_dtmf_preference"], [self boolForKey:@"rfc_dtmf_preference"]);
    ...
    NSString* stun_server = @"stun.dcalling.de";
